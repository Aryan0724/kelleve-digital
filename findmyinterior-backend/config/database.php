    ...
    */
    ...
    'connections' => [
        ...
        'mysql' => [
            ...
            'database' => env('DB_DATABASE', 'findmyinterior'),
        ...
        'auth' => [
            ...
            'database' => env('DB_CONNECTION') === 'sqlite' ? env('DB_DATABASE', database_path('database.sqlite')) : env('DB_AUTH_DATABASE', env('DB_DATABASE', 'findmyinterior')),
        ...
        'truedial' => [
            ...
            'database' => env('DB_CONNECTION') === 'sqlite' ? env('DB_DATABASE', database_path('database.sqlite')) : env('DB_TRUEDIAL_DATABASE', env('DB_DATABASE', 'truedial_db')),
