    ...
    public function run()
    {
        ...
        $blogs = [
            [
                ...
                'cover_image' => 'https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?auto=format&fit=crop&q=80&w=1000',
                'category' => 'Design', 'author_id' => $authorId,
                'status' => 'published',
                'target_audience' => json_encode(['interior_designer', 'homeowner', 'contractor', 'interior_company']),
            ...
            [
                ...
                'cover_image' => 'https://images.unsplash.com/photo-1504307651254-35680f356dfd?auto=format&fit=crop&q=80&w=1000',
                'category' => 'Design', 'author_id' => $authorId,
                'status' => 'published',
                'target_audience' => json_encode(['homeowner', 'customer']),
            ...
            [
                ...
                'cover_image' => 'https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?auto=format&fit=crop&q=80&w=1000',
                'category' => 'Design', 'author_id' => $authorId,
                'status' => 'published',
                'target_audience' => json_encode(['homeowner', 'interior_designer']),
                'published_at' => Carbon::now()->subDays(15),
                'created_at' => Carbon::now(),
                'updated_at' => Carbon::now(),
            ],
            [
                'title' => 'The Ultimate Guide to Modern Kitchen Remodeling',
                'slug' => 'ultimate-guide-kitchen-remodeling',
                'content' => '<h2>Planning Your Dream Kitchen</h2><p>The kitchen is the heart of the home. A well-designed kitchen not only improves functionality but also significantly increases property value.</p><h3>Layout Matters Most</h3><p>Whether you choose an L-shaped, U-shaped, or island layout, ensure the kitchen work triangle (sink, stove, refrigerator) is efficient. Quality materials like quartz countertops and soft-close cabinets are worth the investment.</p>',
                'excerpt' => 'Everything you need to know before starting a kitchen renovation, from layout planning to budget management.',
                'cover_image' => 'https://images.unsplash.com/photo-1556911220-e15b29be8c8f?auto=format&fit=crop&q=80&w=1000',
                'category' => 'Renovation', 'author_id' => $authorId,
                'status' => 'published',
                'target_audience' => json_encode(['contractor', 'interior_designer', 'homeowner']),
            ...
            [
                ...
                'category' => 'Design', 'author_id' => $authorId,
                'status' => 'published',
                'target_audience' => json_encode(['interior_designer', 'contractor', 'interior_company']),
