    ...
    public function run()
    {
        ...
        $blogs = [
            [
                ...
                'status' => 'published',
                'target_audience' => json_encode(['designer', 'homeowner', 'contractor', 'interior_company']),
            ...
            [
                ...
                'category' => 'Design', 'author_id' => $authorId,
                'status' => 'published',
                'target_audience' => json_encode(['homeowner', 'designer']),
            ...
            [
                ...
                'category' => 'Design', 'author_id' => $authorId,
                'status' => 'published',
                'target_audience' => json_encode(['contractor', 'designer', 'homeowner']),
            ...
            [
                ...
                'category' => 'Design', 'author_id' => $authorId,
                'status' => 'published',
                'target_audience' => json_encode(['designer', 'contractor', 'interior_company']),
