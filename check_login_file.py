...
with sftp.file('/root/test_login.php', 'w') as f:
    f.write(tinker_code)
sftp.close()
stdin, stdout, stderr = client.exec_command('docker cp /root/test_login.php fmi_backend:/var/www/html/test_login.php && docker exec fmi_backend php test_login.php')
