...
import { 
  ...
  TrendingUp, PhoneCall, Globe, ArrowRight, Activity 
} from "lucide-react";
...
export default function VendorDashboardOverview() {
  ...
  const [recentLeads, setRecentLeads] = useState([
    { id: 1, name: "Rohit Kumar", inquiry: "Interior Consultation Quote", time: "2 hours ago", status: "New" },
    { id: 2, name: "Ananya Iyer", inquiry: "Modular Kitchen Design", time: "5 hours ago", status: "Contacted" },
    { id: 3, name: "Vikram Mehta", inquiry: "Office Renovation", time: "1 day ago", status: "Closed" }
  ]);
