        ...
        <div className="w-full lg:w-[48%] flex flex-col justify-center px-6 xl:pl-[max(2rem,calc((100vw-1320px)/2+1rem))] xl:pr-10 py-10 lg:py-16 z-10">
          ...
          <div className="flex flex-wrap items-center gap-3 mb-8">
            <Link 
              ...
              className="flex items-center gap-2 bg-[#FF6B00] hover:bg-[#e66000] text-white font-bold text-[14px] px-7 py-3 rounded-lg shadow-md hover:shadow-lg transition-all"
            >
            ...
            <Link 
              href="/professionals"
              className="flex items-center gap-2 bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-600 text-[#374151] dark:text-white font-bold text-[14px] px-7 py-3 rounded-lg hover:border-slate-400 hover:bg-slate-50 dark:hover:bg-slate-700 transition-all"
            >
