...
`;
  ...
  const cmd = `echo '${base64Script}' | base64 -d > /var/www/find-my-interior/reset-password.php && docker compose -f /var/www/find-my-interior/docker-compose.yml exec -T backend php artisan tinker /var/www/find-my-interior/reset-password.php`;
