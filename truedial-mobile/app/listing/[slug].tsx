    ...
    <View className="flex-1 bg-white dark:bg-slate-950">
      ...
      >
        ...
        <View className="px-4 py-5 flex-row justify-between bg-white dark:bg-slate-950 border-b border-slate-200 dark:border-slate-800">
          ...
          >
            <View className="w-12 h-12 rounded-full bg-white dark:bg-slate-900 items-center justify-center mb-1 border border-emerald-500 shadow-sm">
          ...
          >
            <View className="w-12 h-12 rounded-full bg-emerald-500 items-center justify-center mb-1 shadow-sm">
          ...
          <TouchableOpacity
            ...
            onPress={() => setIsSaved(!isSaved)}
          >
            <View className="w-12 h-12 rounded-full bg-white dark:bg-slate-900 items-center justify-center mb-1 border border-rose-500 shadow-sm">
              <Heart
                size={20}
                color="#F43F5E"
